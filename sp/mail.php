...
<div class="main">
	...
	<header>
		<div class="title"><h1><a href="">mail</a></h1></div>
	</header>
	<div id="form_space">
	<form id="demo" action="./send.php" >
		<ul>
			<li>
				<label for="name">名前：</label>
				<span>
					<input id="name" name="firstname" type="text" class="field" value="" maxlength="20" tabindex="1" /><br>
				</span>
				<div class="clearleft"></div>
			</li>
			<li>
